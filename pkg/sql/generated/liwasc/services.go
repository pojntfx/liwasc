...
type Service struct {
	...
	RegistrationDate        string `boil:"registration_date" json:"registration_date" toml:"registration_date" yaml:"registration_date"`
	ModificationDate        string `boil:"modification_date" json:"modification_date" toml:"modification_date" yaml:"modification_date"`
	Reference               string `boil:"reference" json:"reference" toml:"reference" yaml:"reference"`
	ServiceCode             string `boil:"service_code" json:"service_code" toml:"service_code" yaml:"service_code"`
	UnauthorizedUseReported string `boil:"unauthorized_use_reported" json:"unauthorized_use_reported" toml:"unauthorized_use_reported" yaml:"unauthorized_use_reported"`
	AssignmentNotes         string `boil:"assignment_notes" json:"assignment_notes" toml:"assignment_notes" yaml:"assignment_notes"`
...
var ServiceColumns = struct {
	...
	UnauthorizedUseReported: "unauthorized_use_reported",
...
var ServiceWhere = struct {
	...
	Assignee                whereHelperstring
	Contact                 whereHelperstring
	RegistrationDate        whereHelperstring
	ModificationDate        whereHelperstring
	Reference               whereHelperstring
	ServiceCode             whereHelperstring
	UnauthorizedUseReported whereHelperstring
	AssignmentNotes         whereHelperstring
}{
	ServiceName:             whereHelperstring{field: "\"services\".\"service_name\""},
	...
	Assignee:                whereHelperstring{field: "\"services\".\"assignee\""},
	Contact:                 whereHelperstring{field: "\"services\".\"contact\""},
	RegistrationDate:        whereHelperstring{field: "\"services\".\"registration_date\""},
	ModificationDate:        whereHelperstring{field: "\"services\".\"modification_date\""},
	Reference:               whereHelperstring{field: "\"services\".\"reference\""},
	ServiceCode:             whereHelperstring{field: "\"services\".\"service_code\""},
	UnauthorizedUseReported: whereHelperstring{field: "\"services\".\"unauthorized_use_reported\""},
	AssignmentNotes:         whereHelperstring{field: "\"services\".\"assignment_notes\""},
}
...
var (
	serviceAllColumns            = []string{"service_name", "port_number", "transport_protocol", "description", "assignee", "contact", "registration_date", "modification_date", "reference", "service_code", "unauthorized_use_reported", "assignment_notes"}
	serviceColumnsWithoutDefault = []string{"service_name", "transport_protocol", "description", "assignee", "contact", "registration_date", "modification_date", "reference", "service_code", "unauthorized_use_reported", "assignment_notes"}
	serviceColumnsWithDefault    = []string{"port_number"}
	servicePrimaryKeyColumns     = []string{"port_number"}
)
...
func FindService(ctx context.Context, exec boil.ContextExecutor, portNumber int64, selectCols ...string) (*Service, error) {
	serviceObj := &Service{}
	...
	query := fmt.Sprintf(
		"select %s from \"services\" where \"port_number\"=?", sel,
	)

	q := queries.Raw(query, portNumber)
...
func (o *Service) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	o.PortNumber = int64(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == serviceMapping["port_number"] {
		goto CacheNoHooks
	}
...
func (o *Service) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"services\" WHERE \"port_number\"=?"
...
func (o *Service) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindService(ctx, exec, o.PortNumber)
	if err != nil {
		return err
	}
...
func ServiceExists(ctx context.Context, exec boil.ContextExecutor, portNumber int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"services\" where \"port_number\"=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, portNumber)
	}
	row := exec.QueryRowContext(ctx, sql, portNumber)
