...
type NodeWakeMessage struct {
	...
	PoweredOne bool   `protobuf:"varint,6,opt,name=PoweredOne,proto3" json:"PoweredOne,omitempty"`
}
...
func (x *NodeWakeMessage) GetPoweredOne() bool {
	if x != nil {
		return x.PoweredOne
	}
	return false
...
var file_node_wake_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x4d, 0x41, 0x43, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xaf, 0x01, 0x0a,
	...
	,
	...
	0x4e, 0x6f, 0x64, 0x65, 0x57, 0x61, 0x6b, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x30,
	0x01, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x70, 0x6f, 0x6a, 0x6e, 0x74, 0x66, 0x78, 0x2f, 0x6c, 0x69, 0x77, 0x61, 0x73, 0x63, 0x2f, 0x70,
...
var file_node_wake_proto_goTypes = []interface{}{
	(*NodeWakeStartMessage)(nil), // 0: com.pojtinger.felicitas.liwasc.NodeWakeStartMessage
	(*NodeWakeMessage)(nil),      // 1: com.pojtinger.felicitas.liwasc.NodeWakeMessage
	(*empty.Empty)(nil),          // 2: google.protobuf.Empty
}
var file_node_wake_proto_depIdxs = []int32{
	0, // 0: com.pojtinger.felicitas.liwasc.NodeWakeService.StartNodeWake:input_type -> com.pojtinger.felicitas.liwasc.NodeWakeStartMessage
	2, // 1: com.pojtinger.felicitas.liwasc.NodeWakeService.SubscribeToNodeWakes:input_type -> google.protobuf.Empty
	1, // 2: com.pojtinger.felicitas.liwasc.NodeWakeService.StartNodeWake:output_type -> com.pojtinger.felicitas.liwasc.NodeWakeMessage
	1, // 3: com.pojtinger.felicitas.liwasc.NodeWakeService.SubscribeToNodeWakes:output_type -> com.pojtinger.felicitas.liwasc.NodeWakeMessage
...
func (c *nodeWakeServiceClient) StartNodeWake(ctx context.Context, in *NodeWakeStartMessage, opts ...grpc.CallOption) (*NodeWakeMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.liwasc.NodeWakeService/StartNodeWake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeWakeServiceClient) SubscribeToNodeWakes(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NodeWakeService_SubscribeToNodeWakesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeWakeService_serviceDesc.Streams[0], "/com.pojtinger.felicitas.liwasc.NodeWakeService/SubscribeToNodeWakes", opts...)
	if err != nil {
		return nil, err
	}
...
func _NodeWakeService_StartNodeWake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.liwasc.NodeWakeService/StartNodeWake",
	}
