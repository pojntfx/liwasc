...
var file_metadata_proto_goTypes = []interface{}{
	(*MetadataMessage)(nil), // 0: com.pojtinger.felicitas.liwasc.MetadataMessage
	(*empty.Empty)(nil),     // 1: google.protobuf.Empty
}
var file_metadata_proto_depIdxs = []int32{
	1, // 0: com.pojtinger.felicitas.liwasc.MetadataService.GetMetadata:input_type -> google.protobuf.Empty
	0, // 1: com.pojtinger.felicitas.liwasc.MetadataService.GetMetadata:output_type -> com.pojtinger.felicitas.liwasc.MetadataMessage
...
func (c *metadataServiceClient) GetMetadata(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*MetadataMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felicitas.liwasc.MetadataService/GetMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetadataService_GetMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felicitas.liwasc.MetadataService/GetMetadata",
	}
