...
func (x *NodeWakeStartNeoMessage) GetMACAddress() string {
	if x != nil {
		return x.MACAddress
	}
	return ""
...
func (x *NodeWakeNeoMessage) GetPriority() int64 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *NodeWakeNeoMessage) GetMACAddress() string {
	if x != nil {
		return x.MACAddress
	}
	return ""
...
var file_node_wake_neo_proto_rawDesc = []byte{
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x4d, 0x41, 0x43,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xb2, 0x01, 0x0a, 0x12, 0x4e, 0x6f, 0x64, 0x65,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x57, 0x61, 0x6b, 0x65, 0x4e, 0x65, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x64, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x6f,
	0x4e, 0x6f, 0x64, 0x65, 0x57, 0x61, 0x6b, 0x65, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
...
var file_node_wake_neo_proto_goTypes = []interface{}{
	(*NodeWakeStartNeoMessage)(nil), // 0: com.pojtinger.felix.liwasc.neo.NodeWakeStartNeoMessage
	(*NodeWakeNeoMessage)(nil),      // 1: com.pojtinger.felix.liwasc.neo.NodeWakeNeoMessage
	(*empty.Empty)(nil),             // 2: google.protobuf.Empty
}
var file_node_wake_neo_proto_depIdxs = []int32{
	0, // 0: com.pojtinger.felix.liwasc.neo.NodeWakeNeoService.StartNodeWake:input_type -> com.pojtinger.felix.liwasc.neo.NodeWakeStartNeoMessage
	2, // 1: com.pojtinger.felix.liwasc.neo.NodeWakeNeoService.SubscribeToNodeWakes:input_type -> google.protobuf.Empty
	1, // 2: com.pojtinger.felix.liwasc.neo.NodeWakeNeoService.StartNodeWake:output_type -> com.pojtinger.felix.liwasc.neo.NodeWakeNeoMessage
	1, // 3: com.pojtinger.felix.liwasc.neo.NodeWakeNeoService.SubscribeToNodeWakes:output_type -> com.pojtinger.felix.liwasc.neo.NodeWakeNeoMessage
...
func (c *nodeWakeNeoServiceClient) StartNodeWake(ctx context.Context, in *NodeWakeStartNeoMessage, opts ...grpc.CallOption) (*NodeWakeNeoMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.liwasc.neo.NodeWakeNeoService/StartNodeWake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeWakeNeoServiceClient) SubscribeToNodeWakes(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NodeWakeNeoService_SubscribeToNodeWakesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeWakeNeoService_serviceDesc.Streams[0], "/com.pojtinger.felix.liwasc.neo.NodeWakeNeoService/SubscribeToNodeWakes", opts...)
	if err != nil {
		return nil, err
	}
...
func _NodeWakeNeoService_StartNodeWake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.liwasc.neo.NodeWakeNeoService/StartNodeWake",
	}
...
var _NodeWakeNeoService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.pojtinger.felix.liwasc.neo.NodeWakeNeoService",
