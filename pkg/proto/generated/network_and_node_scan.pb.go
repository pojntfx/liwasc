...
var file_network_and_node_scan_proto_goTypes = []interface{}{
	...
	(*NodeMetadataMessage)(nil),         // 5: com.pojtinger.felix.liwasc.NodeMetadataMessage
	(*DiscoveredServiceMessage)(nil),    // 6: com.pojtinger.felix.liwasc.DiscoveredServiceMessage
	(*NodeDeleteMessage)(nil),           // 7: com.pojtinger.felix.liwasc.NodeDeleteMessage
	(*empty.Empty)(nil),                 // 8: google.protobuf.Empty
}
var file_network_and_node_scan_proto_depIdxs = []int32{
	5, // 0: com.pojtinger.felix.liwasc.DiscoveredNodeMessage.LucidNode:type_name -> com.pojtinger.felix.liwasc.NodeMetadataMessage
	...
	8, // 5: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.SubscribeToNewPeriodicNetworkScans:input_type -> google.protobuf.Empty
	7, // 6: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.DeleteNode:input_type -> com.pojtinger.felix.liwasc.NodeDeleteMessage
	1, // 7: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.TriggerNetworkScan:output_type -> com.pojtinger.felix.liwasc.NetworkScanReferenceMessage
	3, // 8: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.TriggerNodeScan:output_type -> com.pojtinger.felix.liwasc.NodeScanReferenceMessage
	4, // 9: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.SubscribeToNewNodes:output_type -> com.pojtinger.felix.liwasc.DiscoveredNodeMessage
	6, // 10: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.SubscribeToNewOpenServices:output_type -> com.pojtinger.felix.liwasc.DiscoveredServiceMessage
	1, // 11: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.SubscribeToNewPeriodicNetworkScans:output_type -> com.pojtinger.felix.liwasc.NetworkScanReferenceMessage
	5, // 12: com.pojtinger.felix.liwasc.NetworkAndNodeScanService.DeleteNode:output_type -> com.pojtinger.felix.liwasc.NodeMetadataMessage
...
func (c *networkAndNodeScanServiceClient) SubscribeToNewPeriodicNetworkScans(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NetworkAndNodeScanService_SubscribeToNewPeriodicNetworkScansClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NetworkAndNodeScanService_serviceDesc.Streams[2], "/com.pojtinger.felix.liwasc.NetworkAndNodeScanService/SubscribeToNewPeriodicNetworkScans", opts...)
	if err != nil {
		return nil, err
	}
