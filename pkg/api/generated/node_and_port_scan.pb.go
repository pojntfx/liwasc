...
var file_node_and_port_scan_proto_goTypes = []interface{}{
	(*NodeScanStartMessage)(nil), // 0: com.pojtinger.felix.liwasc.NodeScanStartMessage
	(*NodeScanMessage)(nil),      // 1: com.pojtinger.felix.liwasc.NodeScanMessage
	(*NodeMessage)(nil),          // 2: com.pojtinger.felix.liwasc.NodeMessage
	(*PortScanMessage)(nil),      // 3: com.pojtinger.felix.liwasc.PortScanMessage
	(*PortMessage)(nil),          // 4: com.pojtinger.felix.liwasc.PortMessage
	(*empty.Empty)(nil),          // 5: google.protobuf.Empty
}
var file_node_and_port_scan_proto_depIdxs = []int32{
	0, // 0: com.pojtinger.felix.liwasc.NodeAndPortScanService.StartNodeScan:input_type -> com.pojtinger.felix.liwasc.NodeScanStartMessage
	5, // 1: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToNodeScans:input_type -> google.protobuf.Empty
	1, // 2: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToNodes:input_type -> com.pojtinger.felix.liwasc.NodeScanMessage
	2, // 3: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToPortScans:input_type -> com.pojtinger.felix.liwasc.NodeMessage
	3, // 4: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToPorts:input_type -> com.pojtinger.felix.liwasc.PortScanMessage
	1, // 5: com.pojtinger.felix.liwasc.NodeAndPortScanService.StartNodeScan:output_type -> com.pojtinger.felix.liwasc.NodeScanMessage
	1, // 6: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToNodeScans:output_type -> com.pojtinger.felix.liwasc.NodeScanMessage
	2, // 7: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToNodes:output_type -> com.pojtinger.felix.liwasc.NodeMessage
	3, // 8: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToPortScans:output_type -> com.pojtinger.felix.liwasc.PortScanMessage
	4, // 9: com.pojtinger.felix.liwasc.NodeAndPortScanService.SubscribeToPorts:output_type -> com.pojtinger.felix.liwasc.PortMessage
...
func (c *nodeAndPortScanServiceClient) StartNodeScan(ctx context.Context, in *NodeScanStartMessage, opts ...grpc.CallOption) (*NodeScanMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.liwasc.NodeAndPortScanService/StartNodeScan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeAndPortScanServiceClient) SubscribeToNodeScans(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (NodeAndPortScanService_SubscribeToNodeScansClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeAndPortScanService_serviceDesc.Streams[0], "/com.pojtinger.felix.liwasc.NodeAndPortScanService/SubscribeToNodeScans", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *nodeAndPortScanServiceClient) SubscribeToNodes(ctx context.Context, in *NodeScanMessage, opts ...grpc.CallOption) (NodeAndPortScanService_SubscribeToNodesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeAndPortScanService_serviceDesc.Streams[1], "/com.pojtinger.felix.liwasc.NodeAndPortScanService/SubscribeToNodes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *nodeAndPortScanServiceClient) SubscribeToPortScans(ctx context.Context, in *NodeMessage, opts ...grpc.CallOption) (NodeAndPortScanService_SubscribeToPortScansClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeAndPortScanService_serviceDesc.Streams[2], "/com.pojtinger.felix.liwasc.NodeAndPortScanService/SubscribeToPortScans", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *nodeAndPortScanServiceClient) SubscribeToPorts(ctx context.Context, in *PortScanMessage, opts ...grpc.CallOption) (NodeAndPortScanService_SubscribeToPortsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NodeAndPortScanService_serviceDesc.Streams[3], "/com.pojtinger.felix.liwasc.NodeAndPortScanService/SubscribeToPorts", opts...)
	if err != nil {
		return nil, err
	}
...
func _NodeAndPortScanService_StartNodeScan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.liwasc.NodeAndPortScanService/StartNodeScan",
	}
...
var _NodeAndPortScanService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.pojtinger.felix.liwasc.NodeAndPortScanService",
