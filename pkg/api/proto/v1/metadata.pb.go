...
var file_metadata_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x2c,
	0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x6f, 0x6a,
...
var file_metadata_proto_goTypes = []interface{}{
	(*ScannerMetadataMessage)(nil),       // 0: com.pojtinger.felix.liwasc.ScannerMetadataMessage
	(*NodeMetadataReferenceMessage)(nil), // 1: com.pojtinger.felix.liwasc.NodeMetadataReferenceMessage
	(*NodeMetadataMessage)(nil),          // 2: com.pojtinger.felix.liwasc.NodeMetadataMessage
	(*PortMetadataReferenceMessage)(nil), // 3: com.pojtinger.felix.liwasc.PortMetadataReferenceMessage
	(*PortMetadataMessage)(nil),          // 4: com.pojtinger.felix.liwasc.PortMetadataMessage
	(*empty.Empty)(nil),                  // 5: google.protobuf.Empty
}
var file_metadata_proto_depIdxs = []int32{
	5, // 0: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForScanner:input_type -> google.protobuf.Empty
	1, // 1: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForNode:input_type -> com.pojtinger.felix.liwasc.NodeMetadataReferenceMessage
	3, // 2: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForPort:input_type -> com.pojtinger.felix.liwasc.PortMetadataReferenceMessage
	0, // 3: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForScanner:output_type -> com.pojtinger.felix.liwasc.ScannerMetadataMessage
	2, // 4: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForNode:output_type -> com.pojtinger.felix.liwasc.NodeMetadataMessage
	4, // 5: com.pojtinger.felix.liwasc.MetadataService.GetMetadataForPort:output_type -> com.pojtinger.felix.liwasc.PortMetadataMessage
...
func (c *metadataServiceClient) GetMetadataForScanner(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ScannerMetadataMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForScanner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metadataServiceClient) GetMetadataForNode(ctx context.Context, in *NodeMetadataReferenceMessage, opts ...grpc.CallOption) (*NodeMetadataMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *metadataServiceClient) GetMetadataForPort(ctx context.Context, in *PortMetadataReferenceMessage, opts ...grpc.CallOption) (*PortMetadataMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForPort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetadataService_GetMetadataForScanner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForScanner",
	}
...
func _MetadataService_GetMetadataForNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MetadataService_GetMetadataForPort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.liwasc.MetadataService/GetMetadataForPort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
