...
//go:generate sqlboiler sqlite3 -o ../db/sqlite/models/mac2vendor -c ../../configs/sqlboiler/mac2vendor.toml
...
import (
	...
	mac2vendorModels "github.com/pojntfx/liwasc/pkg/db/sqlite/models/mac2vendor"
)
