...
grpcurl -H "X-Liwasc-Authorization: ${AUTH}" -plaintext -d '{ "NodeScanTimeout": 500, "PortScanTimeout": 50, "MACAddress": "02:42:64:96:47:8a" }' -plaintext localhost:15123 com.pojtinger.felix.liwasc.NodeAndPortScanService.StartNodeScan
...
grpcurl -H "X-Liwasc-Authorization: ${AUTH}" -plaintext -d '{ "NodeWakeTimeout": 1000, "MACAddress": "02:42:64:96:47:8a" }' localhost:15123 com.pojtinger.felix.liwasc.NodeWakeService.StartNodeWake
grpcurl -H "X-Liwasc-Authorization: ${AUTH}" -plaintext localhost:15123 com.pojtinger.felix.liwasc.NodeWakeService.SubscribeToNodeWakes
